...
input_node = "Eef2"
out = "/ix/djishnu/Aaron_F/PGM_project/20241030_Resutls/p-sites_of_interest/"

# paths
edge_path = paste0(out, input_node, "_subnetwork.csv")
...
# plot network
pdf(paste0(out, input_node, "_subnetwork_viz.pdf"))
